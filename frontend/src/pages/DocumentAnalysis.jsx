            ...
            <Layout user={user} onLogout={onLogout} pageTitle="Document Analysis">
                <div className="analysis-container">
                    <div style={{ textAlign: 'center', padding: '5rem', color: '#94a3b8' }}>
                        ...
                        Extracting clauses and classifying...
                    </div>
                </div>
            </Layout>
        );
        ...
        return (
            <Layout user={user} onLogout={onLogout} pageTitle="Document Analysis">
                <div className="analysis-container">
                    ...
                    <Link to="/dashboard" className="btn-back" style={{ marginTop: '2rem' }}>
                        ← Back to Dashboard
                    </Link>
                </div>
            </Layout>
        ...
        <Layout user={user} onLogout={onLogout} pageTitle="Document Analysis">
            <div className="analysis-container">
                <div className="analysis-header">
                    ...
                    <h1>Contract Assessment</h1>
                    <div className={`badge badge-${document.status === 'approved' ? 'success' : 'pending'}`}>
                        {document.status}
                    </div>
                </div>
                ...
                {clauses.length === 0 ? (
                    <div className="workspace-card" style={{ textAlign: 'center', padding: '4rem' }}>
                        ...
                        <p style={{ color: '#94a3b8' }}>
                            {status === 'processing'
                                ? "Our AI is currently analyzing this document. Please check back in a few seconds."
                                : "The extraction engine couldn't find any specific clauses in this document."}
                        </p>
                    </div>
                ) : (
