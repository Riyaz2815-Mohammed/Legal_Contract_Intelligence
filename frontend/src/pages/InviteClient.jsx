    ...
    return (
        <Layout user={user} onLogout={onLogout} pageTitle="Send Credentials">
            <div className="dashboard-content-v2">
                ...
                <div className="glass-container" style={{ marginTop: '2rem', padding: '1.5rem', background: 'rgba(99, 102, 241, 0.05)', border: '1px solid rgba(99, 102, 241, 0.1)' }}>
                    ...
                    <ul style={{ color: '#94a3b8', fontSize: '0.875rem', paddingLeft: '1.25rem', lineHeight: '1.6' }}>
